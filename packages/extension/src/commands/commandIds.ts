export enum CommandIds {
    ...
    transformToAlloyFromButton = "tonto.transformToAlloyFromButton",
    transformToAlloy = "tonto.transformToAlloy",
    generateInstancesFromButton = "tonto.generateInstancesFromButton",
    generateInstances = "tonto.generateInstances",
...
export const commandPalletteIds = [
    ...
    CommandIds.transformToAlloy,
    CommandIds.generateInstances,
