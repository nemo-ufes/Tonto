...
```mermaid
flowchart TB
  PhysicalObject["PhysicalObject<br/>(category of objects)"]:::tontoFunctionalComplex
  Customer["Customer<br/>(roleMixin of functional-complexes, collectives)"]:::tontoFunctionalComplex
  Person["Person<br/>(kind)"]:::tontoKind
  Organization["Organization<br/>(kind)"]:::tontoKind
